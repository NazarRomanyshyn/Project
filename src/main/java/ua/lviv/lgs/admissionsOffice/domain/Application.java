...
public class Application implements Serializable {
	...
	@Column
	@NotNull(message = "Середній бал атестата не може бути порожнім!")
	@Min(value = 100, message = "Середній бал атестата не може бути менше 100!")
	@Max(value = 200, message = "Середній бал атестата не може бути більше 200!")
