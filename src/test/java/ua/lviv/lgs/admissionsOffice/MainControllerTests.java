...
import ua.lviv.lgs.admissionsOffice.controller.MainController;
...
public class MainControllerTests {
	...
	@Test
	@WithUserDetails("admissionsOfficeTest@gmail.com")
	...
	@Test
	@WithUserDetails("vasilenko@mail.com")
	...
	public void notAcceptedAppsListTest() throws Exception {
		this.mockMvc.perform(get("/main"))
			.andDo(print())
			.andExpect(authenticated())
			.andExpect(xpath("//*[@id='notAcceptedApps']/div").nodeCount(0));
	}
	...
	public void rejectedAppExistsTest() throws Exception {
		this.mockMvc.perform(get("/main"))
			.andDo(print())
			.andExpect(authenticated())
			.andExpect(content().string(containsString("Деякі подані раніше заявки були відхилені")));			
	}
}